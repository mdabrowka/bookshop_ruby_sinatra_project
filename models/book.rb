...
class Book
  ...
  attr_reader :id
  attr_accessor :title, :author_id, :quantity, :genre, :source_language, :buy_price, :sell_price
  ...
  def save
    sql = "INSERT INTO books (title, author_id, quantity, genre, source_language, buy_price, sell_price)
